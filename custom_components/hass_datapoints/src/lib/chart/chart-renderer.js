import { fmtTime } from "@/lib/util/format.js";
import { hexToRgba } from "@/lib/util/color.js";
...
export class ChartRenderer {
  ...
  _formatTimeTick(t, t0, t1, tickSpanMs = null) {
    ...
    const detailSpanMs =
      Number.isFinite(tickSpanMs) && tickSpanMs > 0 ? tickSpanMs : spanMs;
