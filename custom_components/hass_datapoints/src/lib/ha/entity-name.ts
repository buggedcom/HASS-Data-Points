...
export function entityName(hass: Nullable<HassWithLabels> | undefined, entityId: Nullable<string> | undefined): string {
  if (!hass || !entityId) {
    return entityId || "";
  }
...
export function entityIcon(hass: Nullable<HassWithLabels> | undefined, entityId: Nullable<string> | undefined): string {
  if (!hass || !entityId) {
...
function entityRegistryEntries(hass: Nullable<HassWithLabels> | undefined): [string, RegistryEntryWithIcon][] {
  return Object.entries(hass?.entities || {}) as [string, RegistryEntryWithIcon][];
}
...
function firstRelatedEntityId(
  ...
  return (
    entityRegistryEntries(hass).find(([, entry]) => entry && typeof entry === "object" && matcher(entry))?.[0] || ""
  );
}

export function deviceName(hass: Nullable<HassWithLabels> | undefined, deviceId: Nullable<string> | undefined): string {
  if (!hass || !deviceId) {
    return deviceId || "";
  }
...
export function deviceIcon(hass: Nullable<HassWithLabels> | undefined, deviceId: Nullable<string> | undefined): string {
  if (!hass || !deviceId) {
    return "mdi:devices";
  }
...
export function areaName(hass: Nullable<HassWithLabels> | undefined, areaId: Nullable<string> | undefined): string {
  if (!hass || !areaId) {
    return areaId || "";
  }
...
export function areaIcon(hass: Nullable<HassWithLabels> | undefined, areaId: Nullable<string> | undefined): string {
  if (!hass || !areaId) {
...
export function labelName(hass: Nullable<HassWithLabels> | undefined, labelId: Nullable<string> | undefined): string {
  if (!hass || !labelId) {
    return labelId || "";
  }
...
export function labelIcon(hass: Nullable<HassWithLabels> | undefined, labelId: Nullable<string> | undefined): string {
  if (!hass || !labelId) {
