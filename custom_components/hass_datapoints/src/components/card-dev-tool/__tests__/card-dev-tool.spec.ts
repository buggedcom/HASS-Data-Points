...
describe("card-dev-tool", () => {
  ...
  describe("GIVEN a card with default config", () => {
    ...
    describe("WHEN rendered", () => {
      ...
      it("THEN it has at least one comparison window row", () => {
        const windows = el.shadowRoot.querySelectorAll(".window-row");
  ...
  describe("GIVEN a card where add window is clicked", () => {
    beforeEach(async () => {
      el = await setupCard();
      el.shadowRoot.querySelector(".add-window-btn").click();
      await el.updateComplete;
    });
  ...
  describe("GIVEN a card with two windows where one is removed", () => {
    beforeEach(async () => {
      ...
      el.shadowRoot.querySelector(".add-window-btn").click();
      await el.updateComplete;
      const removeBtn = el.shadowRoot.querySelector(".remove-window-btn");
      removeBtn.click();
      await el.updateComplete;
    });
