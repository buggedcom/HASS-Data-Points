...
function makeBounds(zoomLevel: string): RangeBounds {
  const configs: Record<string, { boundsUnit: string; contextUnit: string; majorUnit: string; labelUnit: string; minorUnit: string; pixelsPerUnit: number; baselineMs: number; detailUnit?: string; detailStep?: number }> = {
    day: {
