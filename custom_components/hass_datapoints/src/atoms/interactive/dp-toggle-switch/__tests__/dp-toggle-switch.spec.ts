...
function createElement(props: Record<string, unknown> = {}) {
  const el = document.createElement("dp-toggle-switch") as HTMLElement & {
    checked: boolean;
    label: string;
    entityId: string | undefined;
  };
  Object.assign(el, { checked: false, label: "Show targets", entityId: undefined, ...props });
  document.body.appendChild(el);
  return el;
}

describe("dp-toggle-switch", () => {
