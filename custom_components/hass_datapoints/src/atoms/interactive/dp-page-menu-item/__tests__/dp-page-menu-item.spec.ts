...
function createElement(props: Record<string, unknown> = {}) {
  const el = document.createElement("dp-page-menu-item") as HTMLElement & {
    icon: string;
    label: string;
    disabled: boolean;
  };
  Object.assign(el, { icon: "mdi:chart-line", label: "History", disabled: false, ...props });
  document.body.appendChild(el);
  return el;
}

describe("dp-page-menu-item", () => {
