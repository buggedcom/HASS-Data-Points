...
function createElement(
  ...
  const el = document.createElement("dp-radio-group") as HTMLElement & {
    name: string;
    value: string;
  ...
  describe("GIVEN a radio group with options", () => {
    ...
    describe("WHEN rendered", () => {
      ...
      it("THEN a fieldset with role radiogroup is present", () => {
        expect.assertions(1);
        const fieldset = el.shadowRoot!.querySelector("fieldset[role='radiogroup']");
