...
function createElement(props: Record<string, unknown> = {}) {
  const el = document.createElement("dp-analysis-checkbox") as HTMLElement & {
    checked: boolean;
    label: string;
    disabled: boolean;
    helpText: string;
...
describe("dp-analysis-checkbox", () => {
  ...
  describe("GIVEN a checkbox with helpText", () => {
    beforeEach(async () => {
      el = createElement({ helpText: "Draws a horizontal line", helpId: "threshold-help" });
      await el.updateComplete;
    });
