...
/**
 * `dp-panel-timeline` wraps `dp-range-timeline` and adds the panel-history-specific
...
export default {
  ...
  argTypes: {
    zoomLevel: {
      control: "select",
      options: ["day", "week_expanded", "week_compressed", "month_short", "month_expanded", "month_compressed", "quarterly"],
    },
    dateSnapping: {
      control: "select",
    ...
    chartHoverTimeMs: { control: "number", description: "Timestamp (ms) of chart hover line. Set to null to hide." },
    chartHoverWindowTimeMs: { control: "number", description: "Timestamp (ms) of comparison chart hover line." },
  },
  args: {
    zoomLevel: "day",
    dateSnapping: "auto",
