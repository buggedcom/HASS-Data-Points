...
export const translations: ComponentTranslations = {
  ...
  "Hide source series": "Quellserie ausblenden",
  "All targets already have the same settings":
    "Alle Ziele haben bereits dieselben Einstellungen",
  "Copy these analysis settings to all targets":
    "Diese Analyseeinstellungen auf alle Ziele kopieren",
  "Copy to all targets": "Auf alle Ziele kopieren",
};
