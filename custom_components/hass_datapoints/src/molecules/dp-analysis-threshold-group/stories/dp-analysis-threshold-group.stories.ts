...
export default {
  title: "Molecules/Analysis/Threshold Group",
  component: "dp-analysis-threshold-group",
  parameters: {
    actions: {
...
export const Checked = {
  render: () => html`
    <dp-analysis-threshold-group
      .analysis=${makeAnalysis({ show_threshold_analysis: true, threshold_value: "25", threshold_direction: "above" })}
      .entityId=${"sensor.temperature"}
      .unit=${"°C"}
    ></dp-analysis-threshold-group>
  `,
...
export const CheckedWithShading = {
  render: () => html`
    <dp-analysis-threshold-group
      .analysis=${makeAnalysis({ show_threshold_analysis: true, show_threshold_shading: true, threshold_value: "25", threshold_direction: "above" })}
      .entityId=${"sensor.temperature"}
      .unit=${"°C"}
    ></dp-analysis-threshold-group>
  `,
