...
import "../dp-analysis-trend-group";
...
function createElement(props: { analysis?: Partial<NormalizedAnalysis>; entityId?: string } = {}) {
  const el = document.createElement("dp-analysis-trend-group") as HTMLElement & {
...
describe("dp-analysis-trend-group", () => {
  ...
  describe("GIVEN show_trend_lines=true", () => {
    beforeEach(async () => {
      el = createElement({ analysis: { show_trend_lines: true, trend_method: "rolling_average" } });
      await el.updateComplete;
    });
