...
export default {
  ...
  component: "dp-analysis-trend-group",
  parameters: {
    actions: {
...
export const Checked = {
  render: () => html`
    <dp-analysis-trend-group
      .analysis=${makeAnalysis({ show_trend_lines: true, trend_method: "rolling_average", trend_window: "24h" })}
      .entityId=${"sensor.temperature"}
    ></dp-analysis-trend-group>
  `,
};
...
export const CheckedLinearTrend = {
  render: () => html`
    <dp-analysis-trend-group
      .analysis=${makeAnalysis({ show_trend_lines: true, trend_method: "linear_trend" })}
      .entityId=${"sensor.temperature"}
    ></dp-analysis-trend-group>
  `,
};
